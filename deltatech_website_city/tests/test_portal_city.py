...
class TestMandatoryFields(TransactionCase):
    ...
    def test_mandatory_fields_enforce_cities(self):
        ...
        from ..controller.website_sale import WebsiteSaleCity

        controller = WebsiteSaleCity()
        fields_set = controller._get_mandatory_billing_address_fields(self.country.sudo())
