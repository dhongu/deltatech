...
class BusinessProject(models.Model):
    ...
    provider_representative = fields.Many2one("res.partner", string="Provider Representative",
                                              domain="[('is_company', '=', False)]",
                                              )


    recipient_company = fields.Char(string="Recipient Company")
    recipient_representative = fields.Many2one("res.partner", string="Recipient Representative",
                                               domain="[('is_company', '=', False)]",
                                               )
