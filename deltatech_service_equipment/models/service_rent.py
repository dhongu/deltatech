        ...
        if self.equipment_id:
            ...
            if meter:
                ...
                readings = meter.meter_reading_ids.filtered(
                    lambda r: not r.consumption_id
                    and r.date <= consumption.period_id.date_stop
                    and r.date >= de_la_data
                ...
                cons_value = {
                    "name": self.invoice_description or self.equipment_id.display_name,
                    "equipment_id": equipment.id,
                    "address_id": equipment.address_id.id,
                }
    ...
    def after_create_consumption(self, consumption):
        ...
        if self.equipment_id:
            ...
            if meter:
                ...
                readings = meter.meter_reading_ids.filtered(
                    lambda r: not r.consumption_id and r.date <= consumption.period_id.date_end and r.date >= de_la_data
                )  # sa fie dupa data de instalare si dupa ultima citire facturata
