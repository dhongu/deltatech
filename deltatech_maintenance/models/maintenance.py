...
class MaintenanceRequest(models.Model):
    ...
    component_ids = fields.One2many('maintenance.request.component', 'request_id', string='Components',
                                    copy=True)
    operation_ids = fields.One2many('maintenance.request.operation', 'request_id', string='Operations',
                                    copy=True)
