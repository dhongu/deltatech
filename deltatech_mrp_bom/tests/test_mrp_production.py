...
class TestMrpProductionBom(TransactionCase):
    ...
    def test_action_compute_derived_bom_twice(self):
        ...
        self.assertEqual(num_moves_1, num_moves_initial, "Numărul de linii nu ar trebui să se schimbe după prima calculare dacă structura e aceeași")
    ...
    def test_derived_bom_reference(self):
        ...
        product_tmpl_v2 = self.env["product.template"].create({
            ...
            "attribute_line_ids": [(0, 0, {
                ...
                "value_ids": [(6, 0, [attr_val_red.id, attr_val_blue.id])]
            })]
        })
        ...
        variant_red = product_tmpl_v2.product_variant_ids.filtered(lambda v: attr_val_red in v.product_template_attribute_value_ids.product_attribute_value_id)
        variant_blue = product_tmpl_v2.product_variant_ids.filtered(lambda v: attr_val_blue in v.product_template_attribute_value_ids.product_attribute_value_id)
