...
..
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:6f6b04a6db40b8b9411f40d3a905a958b93ccbb62231e0f08737cb217f1e3f04
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
- Development status raised from *Beta* to *Production/Stable*. The
  module is consumed by ``deltatech_stock_barcode``, which is itself
  published as *Production/Stable*; ``manifestoo check-dev-status``
  rejects a module that is more mature than one of its dependencies. No
  functional change.
