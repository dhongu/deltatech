...
--- | --- | --- | ---
[deltatech](deltatech/) | 18.0.1.0.1 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Generic module
...
[deltatech_account_edi_ubl_advice](deltatech_account_edi_ubl_advice/) | 18.0.1.0.3 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Deltatech Account UBL despatch advice
[deltatech_account_edi_ubl_gln](deltatech_account_edi_ubl_gln/) | 18.0.1.0.2 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Deltatech Account UBL GLN
...
[deltatech_alternative](deltatech_alternative/) | 18.0.2.1.4 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Alternative product codes
...
[deltatech_gln](deltatech_gln/) | 18.0.1.0.1 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Obsolete - Use account_add_gln
...
[deltatech_invoice_delivery](deltatech_invoice_delivery/) | 18.0.1.0.0 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Create delivery form invoice
...
[deltatech_invoice_to_draft](deltatech_invoice_to_draft/) | 18.0.2.0.1 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Restricted access to reset account move to draft
[deltatech_invoice_weight](deltatech_invoice_weight/) | 18.0.1.0.2 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Invoice Weight
[deltatech_kit_price](deltatech_kit_price/) | 18.0.0.0.2 | [![danila12](https://github.com/danila12.png?size=30px)](https://github.com/danila12) | Compute product cost price in sale order line based on kit
[deltatech_ledger](deltatech_ledger/) | 18.0.0.0.1 | [![VoicuStefan2001](https://github.com/VoicuStefan2001.png?size=30px)](https://github.com/VoicuStefan2001) | Deltatech Ledger
[deltatech_list_view](deltatech_list_view/) | 18.0.1.0.1 |  | List View Select Text
...
[deltatech_mrp_simple](deltatech_mrp_simple/) | 18.0.1.1.1 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Simple production
...
[deltatech_partner_minimal_aquisition](deltatech_partner_minimal_aquisition/) | 18.0.0.0.0 | [![VoicuStefan2001](https://github.com/VoicuStefan2001.png?size=30px)](https://github.com/VoicuStefan2001) | Warns you if your PO to a partner hasn't reached a minimal value
[deltatech_payment_forecast](deltatech_payment_forecast/) | 18.0.0.0.4 |  | Generates a report to estimate payments at a certain date
[deltatech_payment_report](deltatech_payment_report/) | 18.0.1.0.2 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Payment Report
[deltatech_payment_term](deltatech_payment_term/) | 18.0.2.0.1 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Term Rate Wizard
[deltatech_payment_term_fix](deltatech_payment_term_fix/) | 18.0.1.0.0 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Payment Term Fix
[deltatech_payment_term_restrict](deltatech_payment_term_restrict/) | 18.0.0.0.1 | [![danila12](https://github.com/danila12.png?size=30px)](https://github.com/danila12) | Restricts payment terms change for certain users
[deltatech_picking_number](deltatech_picking_number/) | 18.0.2.0.0 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Picking Number
[deltatech_picking_restrict](deltatech_picking_restrict/) | 18.0.1.0.0 | [![danila12](https://github.com/danila12.png?size=30px)](https://github.com/danila12) | Restrict picking validation to a certain security group
[deltatech_picking_restrict_entry_exit](deltatech_picking_restrict_entry_exit/) | 18.0.0.0.8 | [![VoicuStefan2001](https://github.com/VoicuStefan2001.png?size=30px)](https://github.com/VoicuStefan2001) | You can't create entry/exit picking if there are no purchase/sale atached
...
[deltatech_pos_stock](deltatech_pos_stock/) | 18.0.1.0.0 |  | Display stock in POS
[deltatech_pos_time_interval](deltatech_pos_time_interval/) | 18.0.0.0.0 | [![VoicuStefan2001](https://github.com/VoicuStefan2001.png?size=30px)](https://github.com/VoicuStefan2001) | Searching pos order report to compare 2 time intervals
...
[deltatech_price_change](deltatech_price_change/) | 18.0.1.1.2 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Price Change
...
[deltatech_product_code](deltatech_product_code/) | 18.0.1.0.6 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Product codification internal
...
[deltatech_purchase_price](deltatech_purchase_price/) | 18.0.1.2.10 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Update vendor price after reception
...
[deltatech_sale_activity_report](deltatech_sale_activity_report/) | 18.0.0.0.7 | [![VoicuStefan2001](https://github.com/VoicuStefan2001.png?size=30px)](https://github.com/VoicuStefan2001) | Adds a last modified field to the sale order
...
[deltatech_sale_commission](deltatech_sale_commission/) | 18.0.1.4.7 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Compute sale commission
...
[deltatech_sale_currency](deltatech_sale_currency/) | 18.0.0.0.0 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Sale Currency
[deltatech_sale_feedback](deltatech_sale_feedback/) | 18.0.1.0.5 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Sale Feedback
[deltatech_sale_followup](deltatech_sale_followup/) | 18.0.1.0.2 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Sale Followup
[deltatech_sale_margin](deltatech_sale_margin/) | 18.0.1.1.1 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Check price in sale order
[deltatech_sale_multiple](deltatech_sale_multiple/) | 18.0.1.0.1 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Sale quantity multiple
[deltatech_sale_multiple_website](deltatech_sale_multiple_website/) | 18.0.1.0.3 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Quantity multiple on website
[deltatech_sale_pallet](deltatech_sale_pallet/) | 18.0.1.0.8 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Sale pallet
[deltatech_sale_pallet_website](deltatech_sale_pallet_website/) | 18.0.1.0.2 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Sale pallet
[deltatech_sale_payment](deltatech_sale_payment/) | 18.0.1.1.1 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Payment button in sale order
[deltatech_sale_phone](deltatech_sale_phone/) | 18.0.1.0.2 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Show partner phone in sale order
[deltatech_sale_picking_status](deltatech_sale_picking_status/) | 18.0.1.0.1 | [![danila12](https://github.com/danila12.png?size=30px)](https://github.com/danila12) | Get sale order status from pickings
[deltatech_sale_purchase](deltatech_sale_purchase/) | 18.0.1.0.1 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Sale Purchase
[deltatech_sale_qty_available](deltatech_sale_qty_available/) | 18.0.1.0.1 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Quantity Available
[deltatech_sale_report](deltatech_sale_report/) | 18.0.0.0.0 | [![VoicuStefan2001](https://github.com/VoicuStefan2001.png?size=30px)](https://github.com/VoicuStefan2001) | Sale Report Additional Info
[deltatech_sale_return_cause](deltatech_sale_return_cause/) | 18.0.0.0.7 | [![VoicuStefan2001](https://github.com/VoicuStefan2001.png?size=30px)](https://github.com/VoicuStefan2001) | Return Cause
[deltatech_sale_stage](deltatech_sale_stage/) | 18.0.1.2.4 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Sale Order Stage
[deltatech_sale_team](deltatech_sale_team/) | 18.0.1.0.2 |  | Sale Team Access
[deltatech_sale_transfer](deltatech_sale_transfer/) | 18.0.1.0.1 |  | Sale Prepare Transfer
[deltatech_sale_xls](deltatech_sale_xls/) | 18.0.0.0.0 | [![VoicuStefan2001](https://github.com/VoicuStefan2001.png?size=30px)](https://github.com/VoicuStefan2001) | Import/export sale line from/to Excel
[deltatech_saleorder_pickup_list](deltatech_saleorder_pickup_list/) | 18.0.1.0.0 |  | Pickup list report from sale order
...
[deltatech_stock_count_zero](deltatech_stock_count_zero/) | 18.0.0.0.0 | [![VoicuStefan2001](https://github.com/VoicuStefan2001.png?size=30px)](https://github.com/VoicuStefan2001) | Set inventory line to 0 when empty count is requested
...
[deltatech_stock_inventory](deltatech_stock_inventory/) | 18.0.2.3.9 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Inventory Old Method
...
[deltatech_stock_picking_activity_report](deltatech_stock_picking_activity_report/) | 18.0.0.0.4 | [![VoicuStefan2001](https://github.com/VoicuStefan2001.png?size=30px)](https://github.com/VoicuStefan2001) | Tracks activities and changes on stock pickings
...
[deltatech_test_system](deltatech_test_system/) | 18.0.0.0.9 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Set system status: test or production
...
[deltatech_vendor_stock](deltatech_vendor_stock/) | 18.0.1.1.7 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Vendor stock availability
...
[deltatech_watermark](deltatech_watermark/) | 18.0.3.0.0 | [![dhongu](https://github.com/dhongu.png?size=30px)](https://github.com/dhongu) | Watermark field
...
[deltatech_website_warehouse_stock](deltatech_website_warehouse_stock/) | 18.0.0.0.2 | [![VoicuStefan2001](https://github.com/VoicuStefan2001.png?size=30px)](https://github.com/VoicuStefan2001) | eCommerce Warehouse Stock
