...
# from https://github.com/edsu/microdata/blob/master/microdata.py
...
if __name__ == "__main__":
    ...
    test = """
Subiect: <span itemprop="subject">Formular de contact completat pe site</span><br />

<address itemscope="itemscope" itemtype="http://schema.org/Organization">
    <div>
        De la: <span itemprop="name">[nume]</span>
    </div>
    <div>
    ...
    <div itemprop="address" itemscope="itemscope" itemtype="http://schema.org/PostalAddress">
        <div>
            Oras: <span itemprop="addressLocality">[oras]</span>
        </div>
        <div>
            Judet: <span itemprop="addressRegion">[judet]</span>
        </div>
        <div>
            Telefon: <span itemprop="telephone">[telefon]</span>
        </div>
    </div>
</address>
Mesaj: <span itemprop="message">[mesaj]</span><br />    
