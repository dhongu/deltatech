...
class PurchaseOrder(models.Model):
    ...
    def action_button_confirm_to_invoice(self):
        ...
        if not self.invoice_ids:
            ...
            vals = {"purchase_id": self.id, "type": action["context"]["type"], "currency_id": self.currency_id}
    ...
    def action_button_create_invoice(self):
        ...
        result["context"] = {"default_purchase_id": self.id, "default_date_invoice": self.date_planned[:10]}
