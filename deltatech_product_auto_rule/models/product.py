...
class ProductProduct(models.Model):
    ...
    def create_rule(self):
        warehouse_id = (
            self.env["ir.config_parameter"].sudo().get_param("deltatech_product_auto_rule.default_rule_warehouse_id")
        )
        ...
        location_id = (
            self.env["ir.config_parameter"].sudo().get_param("deltatech_product_auto_rule.default_rule_location_id")
        )
