...
class SaleAdvancePaymentInv(models.TransientModel):
    ...
    def _default_journal(self):
        ...
        if generic_parnter == order.partner_id:
            domain = [("type", "=", "sale"), ("company_id", "=", company_id), ("code", "=", "BF")]
        else:
            domain = [("type", "=", "sale"), ("company_id", "=", company_id), ("code", "!=", "BF")]
    ...
    journal_id = fields.Many2one(
        "account.journal", string="Journal", default=_default_journal, domain="[('type', '=', 'sale')]"
    )  # de adaugat si ('company_id', '=', company_id)
