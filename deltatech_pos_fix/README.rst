...
This fix is a small, focused patch on top of standard ``point_of_sale``.
It is designed to work alongside the rest of the Terrabit POS suite and
the official Romanian fiscal compliance modules, without any overlap:
