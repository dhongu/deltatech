...
- A daily scheduled action (inactive by default) splits codes entered on one line and separated by `;` or `,`
  ...
  Activate it in **Settings > Technical > Scheduled Actions** when needed.
