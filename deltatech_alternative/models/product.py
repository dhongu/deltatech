...
class product_catalog(models.Model):
    ...
    list_price_currency_id = fields.Many2one('res.currency', string='Currency List Price',
                                             help="Currency for list price.", compute='_compute_currency_id')
...
class product_template(models.Model):
    ...
    alternative_ids = fields.One2many('product.alternative', 'product_tmpl_id', string='Alternatives', copy=True)
