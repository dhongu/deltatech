...
class TestEcrFiscalMixin(TransactionCase):
    def test_fields_present_on_both_models(self):
        """Contractul trebuie să existe pe ambele modele, nu doar pe unul."""
        for model in ("pos.order", "account.move"):
    ...
    def test_fields_claimed_by_this_module(self):
        ...
        """
        for model in ("pos.order", "account.move", "account.bank.statement.line"):
