...
class IrHttp(models.AbstractModel):
    ...
    def session_info(self):
        ...
        # regular users over RPC, hence the sudo() here. The SDK itself is
        # provided by a separate companion module (loaded via web.assets_backend
        # as window.BrowserPrint), so this module needs no SDK path.
