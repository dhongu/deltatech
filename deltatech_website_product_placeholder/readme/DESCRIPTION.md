This module allows you to configure a custom placeholder image for products that do not have an image set.
Optimizes website performance by serving a single static or configurable URL for all products without images, which improves browser and CDN caching.
