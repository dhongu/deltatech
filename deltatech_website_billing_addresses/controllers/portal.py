...
class CustomerPortal(portal.CustomerPortal):
    ...
    @http.route(['/my/billing_addresses', '/my/billing_addresses/page/<int:page>'], type='http', auth='user',
                website=True)
    def portal_my_billing_addresses(self, page=1, date_begin=None, date_end=None, sortby=None, search=None,
                                    search_in='all',
    ...
    @http.route(['/my/shipping_addresses', '/my/shipping_addresses/page/<int:page>'], type='http', auth='user',
                website=True)
    def portal_my_shipping_addresses(self, page=1, date_begin=None, date_end=None, sortby=None, search=None,
                                    search_in='all',
                                    groupby='none', filterby=None, **kw):
        values = self._prepare_portal_layout_values()
