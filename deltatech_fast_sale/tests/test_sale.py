...
class TestSale(TransactionCase):
    ...
    def test_sale_confirm_to_invoice(self):
        ...
        self.so = so.save()
        self.so.action_button_confirm_to_invoice()

    def test_sale_confirm_notice(self):
        so = Form(self.env["sale.order"])
        so.partner_id = self.partner_a
        ...
        self.so.action_button_confirm_notice()
        self.so.picking_ids.action_view_sale_invoice()
