...
This module extends `deltatech_sale_add_extra_line` into the POS front-end. It is designed to work
...
- **deltatech_pos_stock** — shows available stock directly in the POS interface
- **deltatech_pos_price_sync** — pushes live product price changes to already open POS sessions
