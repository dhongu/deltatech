...
class ProductTemplate(models.Model):
    ...
    list_price_bronze = fields.Float(string="Bronze Price", compute="_compute_price_list",
                                     track_visibility='always', store=True, readonly=True,
                                     compute_sudo=True
                                     )
    list_price_silver = fields.Float(string="Silver Price", compute="_compute_price_list",
                                     track_visibility='always', store=True, readonly=True, compute_sudo=True)
    list_price_gold = fields.Float(string="Gold Price", compute="_compute_price_list",
                                   track_visibility='always', store=True, readonly=True, compute_sudo=True)
