...
sAnimation.registry.productsSliderSnippet = sAnimation.Class.extend({
    ...
    _render: function (res) {
        ...
        this.mobileCarousel = $(qweb.render('deltatech_website_product_slider_snippet.productsSlider', {
            uniqueId: this.uniqueId,
            productFrame: 1,
            productsGroups: mobileProducts,
        }));
        this.webCarousel = $(qweb.render('deltatech_website_product_slider_snippet.productsSlider', {
            uniqueId: this.uniqueId,
            productFrame: 4,
