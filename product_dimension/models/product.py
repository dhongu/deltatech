...
class Product(models.Model):
    ...
    height = fields.Float()
    width = fields.Float()
    dimensional_uom_id = fields.Many2one('product.uom', 'Dimensional UoM', domain=_get_dimension_uom_domain,
...
class ProductTemplate(models.Model):
    ...
    dimensional_uom_id = fields.Many2one('product.uom', 'Dimensional UoM',
