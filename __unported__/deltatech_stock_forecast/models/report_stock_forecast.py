...
class ReportStockForecat(models.Model):
    ...
    def read_group(self, domain, fields, groupby, offset=0, limit=None, orderby=False, lazy=True):
        ...
        res = super(ReportStockForecat, self).read_group(
        ...
        if "cumulative_quantity" in fields:
            for index, line in enumerate(res):
                ...
                if line.get("product_id"):
                    ...
                    cumulative_quantity_by_products[product_id] += line[
                        "quantity"
                    ]  # Get cumulative quantity product wise
                    line["cumulative_quantity"] = cumulative_quantity_by_products[
                        product_id
                    ]  # Sum of all quantities (i.e. cumulative quantity) product wise
                    ...
                    if line["reference"] == "Starting Inventory":
                        if index == 0:
                            ...
                            line["quantity"] = 0.0
                            line["cumulative_quantity"] = res[index - 1][
                                "cumulative_quantity"
                            ]  # Set cumulatiove quantity if line does not have any cumulative
