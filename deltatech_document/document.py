...
class document_file(models.Model):
    ...
    state = fields.Selection([('draft','Draft'),('valid','Valid'),('to_approved','To Be Approved'),('approved','Approved'),('obsoleted','Obsoleted')], default="valid")
    categ_id = fields.Many2one('document.category', string="Category",readonly=True, states={'draft': [('readonly', False)]})
    ...
    approved_by = fields.Many2many('res.users','document_approved_by', 'document_id','user_id', string='Approved by', copy=False, readonly=True)
